ActionController::Routing::Routes.draw do |map|  
  ...
  map.namespace(:admin) do |admin|
    ...
    admin.resources :product_lines, :as => 'product-lines' do |pl|
      pl.resources :parts, :controller => 'parts_manager', :collection => { :recent => :get, :search => :get, :filter => :get, :labels => :get }
  ...
  map.resources :publication_categories, :as => 'publications' do |ppub|
    ppub.resources :publication_titles, :as => 'titles', :conditions => { :format => :html }
