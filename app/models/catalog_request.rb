    ...
    def catalogs_hash
      {
        ...
        :tc_volume_6 => "Torque Converter Catalog Volume 6",
        :hp_volume_6 => "High Performance Catalog Volume 6",
        ...
        :diagnostic_guide_espanol => "Diagnostic Guide en Espanol",
        :ts_espanol => "Transmission Specialties&reg; en Espanol",
        :ts_chinese => "Transmission Specialties&reg; in Chinese",
        :tc_chinese => "Torque Converter Catalog in Chinese",
