...
ActiveRecord::Schema.define(:version => 20110316165334) do
  ...
  create_table "part_redirects", :force => true do |t|
  ...
  add_index "product_lines", ["type"], :name => "index_product_lines_on_type"
